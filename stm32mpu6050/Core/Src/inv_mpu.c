...
#define delay_ms    mpu6050_delay
#define get_ms      mpu6050_get_ms
...
const struct test_s test = {
    ...
    .wait_ms        = 50,
    .packet_thresh  = 5,    /* 5% */
    .min_dps        = 5.f,          // 放宽：从10.f改为5.f
    .max_dps        = 200.f,        // 放宽：从105.f改为200.f
    .max_gyro_var   = 0.3f,         // 放宽：从0.14f改为0.3f
    .min_g          = 0.1f,         // 放宽：从0.3f改为0.1f
    .max_g          = 1.5f,         // 放宽：从0.95f改为1.5f
    .max_accel_var  = 0.3f          // 放宽：从0.14f改为0.3f
};
